...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', fullWidth, ...props }, ref) => {
    const variants = {
      ...
      ghost: 'bg-transparent border-2 border-duo-border text-duo-gray shadow-[0_4px_0_0_var(--border-color)] enabled:hover:bg-white/5 enabled:active:shadow-none enabled:active:translate-y-[4px]',
